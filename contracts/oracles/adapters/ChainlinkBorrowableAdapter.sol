...
abstract contract ChainlinkBorrowableAdapter is BaseOracle {
    ...
    uint256 public immutable BORROWABLE_STALE_TIMEOUT;
    ...
    constructor(address feed, uint256 staleTimeout, uint256 boundOffsetFactor) {
        ...
        BORROWABLE_STALE_TIMEOUT = staleTimeout;
    ...
    function borrowablePrice() public view virtual override returns (uint256) {
        return _CHAINLINK_BORROWABLE_FEED.price(BORROWABLE_STALE_TIMEOUT, BORROWABLE_BOUND_OFFSET_FACTOR);
    }
}
